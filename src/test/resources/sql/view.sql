...
select g.id as gid,p.id as pid,kc.id as kid, g.name as gname ,'' as sph ,'' as cyl,
...
left join tk_kc kc on g.id = kc.goodsid 
left join tg_price p on g.id = p.goodsid 
where kind.a1 = 'false' ;


create or replace view v_goodsLens as
select g.id as gid,p.id as pid,kc.id as kid, g.name as gname ,l.sph as sph ,l.cyl as cyl,
kind.text as kind, brand.text as brand,version.text as version,color.text as color,
a.a1,a.a2,a.a3,a.a4,a.a5,a.a6,a.a7,a.a8,a.a9,a.a10,
kc.num_zheng_pin,kc.num_can_pin,kc.num_ci_pin,kc.num_zeng_pin,kc.num_need,
p.pin,p.pout
